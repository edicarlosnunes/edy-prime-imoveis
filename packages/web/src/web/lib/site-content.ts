...
export const defaultSiteContent: SiteContent = {
  ...
  hero: {
    ...
    contentSide: "left",
    assurances: [
      { id: "a1", text: "Especialista no litoral" },
      { id: "a2", text: "Imóveis selecionados" },
      { id: "a3", text: "Atendimento humano e ágil" },
    ],
  },
  menu: {
    logoText: "E. Santos",
  ...
  sections: {
    ...
    imoveis: {
      ...
      subtitle: "Opções escolhidas para facilitar sua busca no litoral.",
    ...
    contato: {
      ...
      title: "Quer saber quanto vale o seu imóvel?",
      titleAccent: "",
      subtitle: "",
      text: "Conte-me algumas informações sobre o imóvel e eu faço uma análise inicial considerando localização, características e o cenário atual do mercado.",
  ...
  seo: {
    ...
    ogImageUrl: "https://www.edyprimeimoveis.com.br/og-esantos.png",
