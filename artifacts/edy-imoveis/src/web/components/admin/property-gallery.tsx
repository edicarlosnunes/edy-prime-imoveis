...
export function PropertyGallery({
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-[10px] border border-white/10 bg-white/5 px-4 py-3">
        ...
        <label className="inline-flex cursor-pointer items-center gap-2 rounded-[3px] border border-white/10 bg-white/5 px-4 py-2.5 text-xs tracking-wide uppercase hover:bg-white/10">
      ...
      {images.length === 0 ? (
        <div className="rounded-[10px] border border-dashed border-white/10 px-6 py-12 text-center">
          <Camera className="mx-auto h-6 w-6 text-slate-400" />
          <p className="mt-3 text-sm text-slate-200">Este imóvel ainda não tem fotos</p>
        ...
        <ul className="grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-4">
          {images.map((image, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-1 border-t border-white/10 px-2 py-2">
                <button
                  type="button"
                ...
                >
                  <ArrowLeft className="h-3.5 w-3.5 text-slate-400 hover:text-slate-200" />
                </button>
                <button
                  type="button"
                ...
                >
                  <Star
                    className={
                      image.isPrimary ? "h-3.5 w-3.5 text-brass" : "h-3.5 w-3.5 text-slate-400"
                    }
                  />
                </button>
                <button
                ...
                <button
                  ...
                  className="rounded p-1 disabled:opacity-30"
                >
                  <ArrowRight className="h-3.5 w-3.5 text-slate-400 hover:text-slate-200" />
                </button>
              </div>
            </li>
          ))}
